...
import (
	...
	"github.com/boost-mentor/kubernetes-production-labs/00_NIGHT_SHIFT_APP/internal/service"
...
func main() {
	...
	logger.Info("night shift api started",
		"address", server.Addr,
		"pod", hostname,
	...
	logger.Info("night shift api stopped")
}
...
func buildStore() (store.OrderStore, error) {
	...
	return store.NewPostgres(store.PostgresConfig{
		...
		Port:     port,
		User:     envOr("DB_USER", "nightshift"),
		Password: os.Getenv("DB_PASSWORD"),
		Database: envOr("DB_NAME", "nightshift"),
