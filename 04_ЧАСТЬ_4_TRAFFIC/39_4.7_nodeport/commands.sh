...
kubectl -n traffic-lab patch svc devops-may-cry --type merge -p '{"spec":{"type":"NodePort"}}'
NODE_PORT="$(kubectl -n traffic-lab get svc devops-may-cry -o jsonpath='{.spec.ports[0].nodePort}')"
